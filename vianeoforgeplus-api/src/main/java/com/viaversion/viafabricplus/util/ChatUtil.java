...
public final class ChatUtil {
    ...
    public static final String PREFIX = ChatFormatting.WHITE + "[" + ChatFormatting.GOLD + "ViaNeoForgePlus" + ChatFormatting.WHITE + "]";
    public static final Component PREFIX_TEXT = Component.literal("[").withStyle(ChatFormatting.WHITE).append(Component.literal("ViaNeoForgePlus").withStyle(ChatFormatting.GOLD)).append("]");
